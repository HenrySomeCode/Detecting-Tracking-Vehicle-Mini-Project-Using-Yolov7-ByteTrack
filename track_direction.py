#For installing cython: https://stackoverflow.com/questions/60349980/is-there-a-way-to-install-cython-bbox-for-windows
...
cv2.resizeWindow("Resized_Window", 950, 540)
...
try:
    while video.isOpened():
        ...
        if ret == True:
            ...
            cv2.imshow("Resized_Window", detected_frame)
